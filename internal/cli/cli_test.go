...
func TestParentHelpShowsOnlyImmediateCommands(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected:   []string{"bookist lists - Manage book lists", "ls        List book lists", "add       Add a book list", "add-book  Add a book to a list", "rm        Remove a book list", "rm-book   Remove a book from a list"},
...
func TestLeafHelpShowsCommandOptionsAndExitsSuccessfully(t *testing.T) {
	tests := []struct {
		...
		{name: "serve", args: []string{"serve", "--help"}, expected: []string{"bookist serve - Start the Bookist server", "--addr string", "--db string", "--data-dir string", "(default: ./data)"}},
		...
		{name: "books edit", args: []string{"books", "edit", "--help"}, expected: []string{"bookist books edit - Edit a book", "[options] <title-or-ID>", "--author string", "--clear string", "--cover string"}},
		...
		{name: "authors edit", args: []string{"authors", "edit", "--help"}, expected: []string{"bookist authors edit - Edit an author", "[options] <name-or-ID>", "--clear string", "--name string"}},
		...
		{name: "lists edit", args: []string{"lists", "edit", "--help"}, expected: []string{"bookist lists edit - Edit a book list", "[options] <name-or-ID>", "--clear string", "--description string"}},
		...
		{name: "reads edit", args: []string{"reads", "edit", "--help"}, expected: []string{"bookist reads edit - Edit a read", "[options] <read-ID>", "--clear string", "--rating float"}},
	}
...
func TestRemoveCommandsRequireExactlyOneOperand(t *testing.T) {
